// LLBrick.cpp: implementation of the CLLBrick class.
//
//////////////////////////////////////////////////////////////////////
...
int CLLBrick::checkCollision(CBin* bin)
{
...
void CLLBrick::operator>>(unsigned char** binImage)
{
...
void CLLBrick::putAtTop(int newOrient,int newPosX)
{
	setPosX(newPosX);
