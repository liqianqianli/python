// TBrick.cpp: implementation of the CTBrick class.
//
//////////////////////////////////////////////////////////////////////
...
int CTBrick::checkCollision(CBin* bin)
{
	...
	if(posX>40)
		posX-=41;
	posY=getPosY();
	if(0==orientation)//T-brick×´Ì¬0
	{//×©¿éÅöµ½±ß½ç
		if((posX-1<0)||(posX+1>width-1)||
	...
	if(1==orientation)//T-brick×´Ì¬1
	{//×©¿éÅöµ½±ß½ç
		if((posX<0)||(posX+1>width-1)||
			(posY-1<0)||(posY+1>height-1))
			return 0;
		//×©¿éÅöµ½ÆäËû¹Ì¶¨×©¿é
