// ZZBrick.cpp: implementation of the CZZBrick class.
//
//////////////////////////////////////////////////////////////////////
...
int CZZBrick::checkCollision(CBin* bin)
{
...
void CZZBrick::operator>>(unsigned char** binImage)
{
...
void CZZBrick::putAtTop(int newOrient,int newPosX)
{
	setPosX(newPosX);
